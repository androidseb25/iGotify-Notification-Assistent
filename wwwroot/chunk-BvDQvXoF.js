...
`;var qe=[`*`];var hi=new C(`SIDEBAR_INSTANCE`);var g1=new C(`SIDEBAR_LAYOUT_INSTANCE`);var jf=new C(`SIDEBAR_ASIDE_INSTANCE`);var qf=new C(`SIDEBAR_CONTENT_INSTANCE`);var Wf=new C(`SIDEBAR_HEADER_INSTANCE`);var Yf=new C(`SIDEBAR_PANEL_INSTANCE`);var Zf=new C(`SIDEBAR_FOOTER_INSTANCE`);var Qf=new C(`SIDEBAR_GROUP_INSTANCE`);var Xf=new C(`SIDEBAR_MENU_INSTANCE`);var Lo=new C(`SIDEBAR_MENU_ITEM_INSTANCE`);var Jf=`
${Eo}
